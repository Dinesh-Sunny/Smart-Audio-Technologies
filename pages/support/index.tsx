                ...
                <div className="self-end flex flex-wrap -m-4 md:pb-24">
                  <div className="">
                    ...
                    <p className="text-gray-600 text-lg">
                      ...
                      are our multi-award winning trusted partners for Order Fulfillment and
                      Customer Support. 
                    </p>
                    
                  </div>
                  <div className="w-full py-8">
                    <div className=" px-8 py-7 bg-white rounded-10 bg-gray-100">
                      <div>
                  ...
                  <div className="w-full">
                    <div className=" px-8 py-7 bg-white rounded-10 bg-gray-100">
                      <div>
                        ...
                        <p className="mb-8 text-gray-600 text-lg">
                          Call us on +44 (0) 1204 474747 or request a callback.
                          <br /> <br />
