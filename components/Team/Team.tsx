...
const Team = () => {
  return (
    <section id="team" className="py-20 bg-white text-primary">
      <div className="relative container px-8 mx-auto">
        <div className="mb-16">
          <h2 className=" text-center mb-4 text-3xl md:text-left md:text-5xl leading-tight text-coolGray-900 font-bold tracking-tighter">
            Our Team
          </h2>
        </div>
 ...
 {/*the below jsx for mobile phones it will be hidden in larger displays  */}
        ...
        <h2 className="text-center  mb-4 py-20 text-3xl md:text-5xl md:text-left leading-tight text-coolGray-900 font-bold tracking-tighter">
          Advisors
        </h2>
